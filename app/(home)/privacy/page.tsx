    ...
    <Container>
      <div className="flex flex-col gap-8 mt-8 privacy">
        ...
        <p>
          ...
          manière dont nous traitons les informations collectées par Dojo
          Mentors, qui fournit également les raisons pour lesquelles nous devons
          ...
          d'utiliser le site web de Dojo Mentors.
        </p>
        <p>
        ...
        <p>
          Lorsque vous visitez le Dojo Mentors, nous recueillons automatiquement
