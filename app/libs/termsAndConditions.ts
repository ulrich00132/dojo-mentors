...
Bienvenue sur Dojo Mentors !

Les présentes conditions générales décrivent les règles et règlements relatifs à l'utilisation du site web de Nubiwi, situé à l'adresse https://www.dojomentors.com/.

En accédant à ce site web, nous supposons que vous acceptez ces conditions générales. Ne continuez pas à utiliser Dojo Mentors si vous n'acceptez pas de prendre toutes les conditions générales énoncées sur cette page.

Cookies :
Le site web utilise des cookies pour aider à personnaliser votre expérience en ligne. En accédant à Dojo Mentors, vous avez accepté d'utiliser les cookies requis.
...
Licence :
Sauf indication contraire, Nubiwi et/ou ses concédants de licence détiennent les droits de propriété intellectuelle de l'ensemble du matériel présent sur Dojo Mentors. Tous les droits de propriété intellectuelle sont réservés. Vous pouvez y accéder à partir de Dojo Mentors pour votre usage personnel, sous réserve des restrictions fixées dans les présentes conditions générales.

Vous ne devez pas :

Copier ou republier des éléments provenant de Dojo Mentors.
Vendre, louer ou concéder une sous-licence pour le matériel provenant de Dojo Mentors.
Reproduire, dupliquer ou copier le matériel provenant de Dojo Mentors.
Redistribuer le contenu de Dojo Mentors
Le présent accord prend effet à la date des présentes.

Certaines parties de ce site web offrent aux utilisateurs la possibilité de publier et d'échanger des opinions et des informations dans certaines zones du site web. Nubiwi ne filtre pas, n'édite pas, ne publie pas et ne révise pas les commentaires avant leur présence sur le site web. Les commentaires ne reflètent pas les vues et opinions de Nubiwi, de ses agents et/ou de ses affiliés. Les commentaires reflètent les vues et opinions de la personne qui les publie. Dans la mesure où les lois applicables le permettent, Nubiwi ne peut être tenu responsable des commentaires ou de toute responsabilité, de tout dommage ou de toute dépense causés et/ou subis à la suite de l'utilisation et/ou de l'affichage et/ou de l'apparition des commentaires sur ce site web.

Nubiwi se réserve le droit de surveiller tous les commentaires et de supprimer tout commentaire qui peut être considéré comme inapproprié, offensant, ou qui entraîne une violation des présentes conditions générales.
...
Par la présente, vous accordez à Nubiwi une licence non exclusive pour utiliser, reproduire, éditer et autoriser d'autres personnes à utiliser, reproduire et éditer n'importe lequel de vos commentaires sous toutes les formes, formats ou médias.
...
Aucune utilisation du logo ou d'autres illustrations de Nubiwi ne sera autorisée pour la création de liens en l'absence d'un accord de licence de marque.
